...
<c:set var='root' value="${pageContext.request.contextPath }/" />
 <div class="wrap">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="${root }main" style="color:#000;">WINEEASY</a>
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item"><a href="index.html" class="nav-link">구독서비스</a></li>
	          <li class="nav-item"><a href="about.html" class="nav-link">와인구매</a></li>
	          <li class="nav-item"><a href="about.html" class="nav-link">공지사항</a></li>
	          <li class="nav-item"><a href="blog.html" class="nav-link">로그인/회원가입</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>