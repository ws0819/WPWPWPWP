...
<body>
	<div>
		<form:form action="${root }notice/notice_modify_pro" modelAttribute="noticeModifyBean" method="post">
			<div>
				<form:hidden path="notice_number"/>
				<form:label path="notice_date">작성날짜</form:label>
				<form:input path="notice_date" readonly="true"/>
			</div>
			<div>
			...
			<div>
				...
				<a href="${root }admin/admin_main">main</a>
			</div>
		</form:form>
	</div>
</body>
