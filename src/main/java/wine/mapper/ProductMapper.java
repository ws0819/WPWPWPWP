...
public interface ProductMapper {
   ...
   @Select("select * from wine_product where wine_nation = #{wine_nation} and wine_type = #{wine_type} "
         + "and wine_variety= #{wine_variety} and wine_sweet = #{wine_sweet}")
   ...
   @Select("select * from wine_product where wine_name like '%'||#{wine_name}||'%'")
   ...
   @Select("select count(*) from wine_product where wine_nation = #{wine_nation} and wine_type = #{wine_type} "
         + "and wine_sweet = #{wine_sweet} and wine_variety=#{wine_variety} ")
   int getSearchWineCount(WineProductBean SearchWienBean);
   
   @Insert("insert into product_order values(product_order_seq.nextval,#{order_id},sysdate,#{order_name},#{order_tel},#{postcode},#{roadAddress},#{jibunaddress},#{order_email},#{order_message})")
