...
public interface UserMapper {
	...
	@Insert("insert into wine_user(user_number, user_id, user_pw, user_name, user_tel, user_address, user_email, user_signdate) "
			+ "values(user_seq.nextval, #{user_id}, #{user_pw}, #{user_name}, #{user_tel}, #{user_address}, #{user_email}, sysdate)")
	...
	@Update("update wine_user set user_pw=#{user_pw}, user_tel=#{user_tel}, user_address=#{user_address}, user_email=#{user_email} where user_number=#{user_number} ")
